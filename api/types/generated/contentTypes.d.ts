...
export interface ApiFeatureVideoFeatureVideo
  extends Struct.CollectionTypeSchema {
  collectionName: 'feature_videos';
  info: {
    displayName: 'featureVideo';
    pluralName: 'feature-videos';
    singularName: 'feature-video';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::feature-video.feature-video'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiJobPostingJobPosting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    jobId: Schema.Attribute.UID<'Role'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    projectDescription: Schema.Attribute.Media<'files'>;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::feature-video.feature-video': ApiFeatureVideoFeatureVideo;
