...
const Donations = () => {
  ...
  <li className="list-group-item">
    <div className="row d-flex align-items-center">
      <div className="w-50 border-right pr-2">Account Name:</div>
      <div className="w-50 p-2 font-weight-bold">Aastha Parivaar</div>
    </div>
  </li>
  <li className="list-group-item">
    <div className="row d-flex align-items-center">
      <div className="w-50 border-right pr-2">Account Number:</div>
      <div className="w-50 p-2 font-weight-bold">30772176552</div>
    </div>
  </li>
  <li className="list-group-item">
    <div className="row d-flex align-items-center">
      <div className="w-50 border-right pr-2">IFSC Code:</div>
      <div className="w-50 p-2 font-weight-bold">SBIN0012924</div>
    </div>
  </li>
  <li className="list-group-item">
    <div className="row d-flex align-items-center">
      <div className="w-50 border-right pr-2">MICR Code:</div>
      <div className="w-50 p-2 font-weight-bold">400002242</div>
    </div>
  </li>
  <li className="list-group-item">
    <div className="row d-flex align-items-center">
      <div className="w-50 border-right pr-2">Branch:</div>
      <div className="w-50 p-2 font-weight-bold">Nehru Nagar, Kurla, Mumbai</div>
    </div>
  </li>
</ul>
        </div>
